...
// Das lokale Gateway wird jetzt dynamisch abgefragt
...
public:
    ...
    bool begin() {
        ...
        if (WiFi.status() == WL_CONNECTED) {
            ...
            // *** KORREKTUR: Nur die Systemzeit auf UTC setzen. Keine Zeitzonen-Info für das System. ***
            time_t utc_time = ntpClient.getEpochTime();
            timeval tv = { utc_time, 0 };
            settimeofday(&tv, nullptr);
            // setenv("TZ", deviceConfig.timezone.c_str(), 1); // ENTFERNT
            // tzset(); // ENTFERNT
